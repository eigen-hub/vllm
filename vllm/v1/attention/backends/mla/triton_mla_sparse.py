...
class TritonMLASparseImpl(XPUMLASparseImpl):
    ...
    3-7x faster for single-query decode on SM80 (A100/A30) and SM120 (GB10).
    """
    ...
    def _warmup_autotune(self, indexer) -> None:
        ...
        # Warm up for both V3 (576) and V4 (512) dimension variants.
        # The V3 variant will be used by DeepSeek V3.2 / GLM-5; the V4
        # variant by DeepSeek V4.  We do both at init to avoid paying the
        # autotune cost on first user request.
